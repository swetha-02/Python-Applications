...
b1 = Button(play, text=' ', font=('calibri',20,'bold'), bg='gray', fg='white', width='7', height='2', command=lambda :
            btnclick(b1))
b1.place(x=100, y=200)

b2 = Button(play, text=' ', font=('calibri',20,'bold'), bg='gray', fg='white', width='7', height='2', command=lambda :
            btnclick(b2))
b2.place(x=215, y=200)

b3 = Button(play, text=' ', font=('calibri',20,'bold'), bg='gray', fg='white', width='7', height='2', command=lambda :
            btnclick(b3))
b3.place(x=330, y=200)

b4 = Button(play, text=' ', font=('calibri',20,'bold'), bg='gray', fg='white', width='7', height='2', command=lambda :
            btnclick(b4))
b4.place(x=100, y=300)

b5 = Button(play, text=' ', font=('calibri',20,'bold'), bg='gray', fg='white', width='7', height='2', command=lambda :
            btnclick(b5))
b5.place(x=215, y=300)

b6 = Button(play, text=' ', font=('calibri',20,'bold'), bg='gray', fg='white', width='7', height='2', command=lambda :
            btnclick(b6))
b6.place(x=330, y=300)

b7 = Button(play, text=' ', font=('calibri',20,'bold'), bg='gray', fg='white', width='7', height='2', command=lambda :
            btnclick(b7))
b7.place(x=100, y=400)

b8 = Button(play, text=' ', font=('calibri',20,'bold'), bg='gray', fg='white', width='7', height='2', command=lambda :
            btnclick(b8))
b8.place(x=215, y=400)

b9 = Button(play, text=' ', font=('calibri',20,'bold'), bg='gray', fg='white', width='7', height='2', command=lambda :
            btnclick(b9))
